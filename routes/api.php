...
Route::get('/CultivUA/{any}', function () {
    $path = public_path('CultivUA/index.html');
...
Route::get('/planta-info', [PlantInformacaoController::class, 'show']); // Para buscar todas as plantas
Route::get('/planta-info/{id}', [PlantInformacaoController::class, 'show']); // Para buscar uma planta específica


// Exibe as informações de uma planta e o kit associado
...
// Atualizar imagem da planta do usuário
...
// Rota para buscar todas as locations
