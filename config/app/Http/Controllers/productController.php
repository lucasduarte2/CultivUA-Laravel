...
use App\Models\Category;  // Certifique-se de importar a classe Category
...
// No seu controller, o método para buscar o produto específico:
public function getProductById($id)
    ...
    {
        // Usando Eloquent com relacionamento
