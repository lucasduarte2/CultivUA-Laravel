...
class DashboardPlantController extends Controller
{
    ...
    {
        // Busca as plantas associadas ao utilizador
    ...
    public function show($id)
    {
        ...
        // Verifique se a planta foi encontrada
        if (!$plantData) {
    ...
    {
        try {
            // Buscar o usuário e a planta com o ID fornecido
            ...
            if ($request->has('image')) {
                // A imagem será um base64, então simplesmente salvamos a string base64 na coluna 'image'
                $imageData = $request->image;

                // Salvar a string base64 diretamente no banco de dados
