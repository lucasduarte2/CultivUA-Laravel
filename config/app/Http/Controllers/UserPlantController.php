...
class UserPlantController extends Controller
{
    public function updatePlant(Request $request, $id)
    {
        try {
            ...
            // Buscar o registro pelo ID fornecido
    ...
    {
        try {
            // Buscar a informação na tabela users_plants pelo user_plant_id
            ...
            return response()->json(['error' => 'Erro ao buscar a planta: ' . $e->getMessage()], 500);
        }
    }
