...
it('retrieves user details successfully', function () {
    ...
    // Realiza a requisição GET para obter os detalhes do usuário
...
it('returns error when user details are not found', function () {
    // Tenta acessar detalhes de um usuário inexistente
...
it('updates user details successfully', function () {
    ...
    // Realiza a requisição PUT para atualizar os detalhes do usuário
...
it('returns error when username is already taken', function () {
    // Cria outro usuário para testar o conflito
...
it('returns error when email is already taken', function () {
    // Cria outro usuário para testar o conflito de e-mail
    $otherUser = User::factory()->create();
...
it('updates password successfully', function () {
    ...
    $data = [
        'currentPassword' => 'password', // Senha atual
        'newPassword' => 'newpassword', // Nova senha
...
it('returns error when current password is incorrect', function () {
    ...
    $data = [
        'currentPassword' => 'wrongpassword', // Senha incorreta
...
it('retrieves user tickets successfully', function () {
    ...
    // Cria um ticket de suporte para o usuário
    $ticket = SupportTicket::factory()->create([
        'user_id' => $this->user->id,
    ]);

    // Realiza a requisição GET para obter os tickets do usuário
