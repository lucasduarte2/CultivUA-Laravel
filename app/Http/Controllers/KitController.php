...
use App\Models\Kit; // Importando a classe Kit
...
class KitController extends Controller
{
    ...
    {
        // Buscar os dados da planta, por exemplo, para o Kit com ID 1
        ...
        // Buscar a temperatura ideal da planta
        $idealTemperatures = [];
    ...
    public function createKit(Request $request)
    {
        ...
        $kit = Kit::create([ // Usando o modelo Kit
